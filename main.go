...
//go:generate protoc --go_out=. --go_opt=module=github.com/chreds/protoc-gen-bq-schema bq_table.proto bq_field.proto
...
import (
	...
	"fmt"
	"os"
	"github.com/chreds/protoc-gen-bq-schema/pkg/converter"
